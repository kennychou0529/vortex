...
`;
  ...
  public readOutputValue(assembly: ShaderAssembly, node: GraphNode, out: string, uv: Expr): Expr {
    ...
    const args = [
      uv,
      assembly.ident(this.uniformName(node.id, 'fx0'), DataType.FLOAT),
      assembly.ident(this.uniformName(node.id, 'fy0'), DataType.FLOAT),
      assembly.ident(this.uniformName(node.id, 'phase0'), DataType.FLOAT),
      assembly.ident(this.uniformName(node.id, 'fx1'), DataType.FLOAT),
      assembly.ident(this.uniformName(node.id, 'fy1'), DataType.FLOAT),
      assembly.ident(this.uniformName(node.id, 'phase1'), DataType.FLOAT),
      assembly.ident(this.uniformName(node.id, 'fx2'), DataType.FLOAT),
      assembly.ident(this.uniformName(node.id, 'fy2'), DataType.FLOAT),
      assembly.ident(this.uniformName(node.id, 'phase2'), DataType.FLOAT),
      assembly.ident(this.uniformName(node.id, 'amplitude'), DataType.FLOAT),
