...
export function formatCssColor([r, g, b]: RGBColor) {
...
// HSL conversion
export const hsl2rgb: (hsl: HSLColor) => RGBColor = require('float-hsl2rgb');
export const rgb2hsl: (rgb: RGBColor) => HSLColor = require('float-rgb2hsl');
